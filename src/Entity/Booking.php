...
class Booking
{
     ...
     * @ORM\Column(type="datetime")
     * @Assert\Date(message="Attention la date doit être au bon format")
     * @Assert\GreaterThan(propertyPath="startDate",message="Votre date d'arrivée doit etre apres la date de départ")
     */
    private $endDate;
    ...
    /**
     * jours correspondant a ma reservation
     *
     * @return array
     */
    ...
    public function isBookableDates(){
        //1)Dates impossible pour l'annonce
