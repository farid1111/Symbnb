...
class Ad
{
     ...
     * @Assert\Length(min=20,max=255,minMessage="Introduction trop courte")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100,minMessage="Contenu trop court")
     */
    private $content;
    ...
    /**
     * Permet de retourner le commentaire d'un client par rapport a une annonce
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Permet d'obtenir la moyenne des notes pour une annonce
     *
     * @return float
     */
